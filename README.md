...
**Change History:**
  ...
  - 6/25/2021:
      - added code to use vcd-cli to start cluster after its provisioned
  - 6/04/2021:  
...
* [Step 4: Setting up mirror registry on Bastion](docs/airgap-cluster-setup.md#setting-up-mirror-registry)
...
* [Step 2: Setup Host Machine Pre-requisites](#setup-host-machine)
  * [Step 2.1: Setup Host Machine](#setup-host-machine)
  * [Step 2.2: Gather Information for terraform.tfvars](#gather-information-for-terraformtfvars)
  * [Step 2.3: Setup airgap pre-requisites](docs/airgap-cluster-setup.md#setup-airgap-pre-requisites)
    * [Step 2.3.1: Adding the registry creds to redhat pull-secret.json](docs/airgap-cluster-setup.md#add-the-mirror-creds-in-the-pull-secretjson)
